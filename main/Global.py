...
grid_size = 'min' # 'min', 'mid', 'big', 'max'
camera_offset = [0, 0]
zoom_factor = 1.0
batch_size = 5
wind_direction = 'bottom_right'  # Initial wind direction (NOTE: actual wind direction is in the opposite direction, so this resembles more as the source direction. This is for consistency of calculations in HexagonGrid)
